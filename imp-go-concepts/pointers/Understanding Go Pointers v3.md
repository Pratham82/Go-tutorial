...
![Pointer memory box diagram](assets/pointers-v3/01-pointer-memory-box.png)
...
![Sequence diagram showing modification through a pointer](assets/pointers-v3/02-modify-sequence.png)
...
![Nil pointer dereference flow diagram](assets/pointers-v3/03-nil-pointer-flow.png)
...
![Function call without a pointer — copies the value](assets/pointers-v3/04-func-without-pointer.png)

![Function call with a pointer — copies the address](assets/pointers-v3/05-func-with-pointer.png)
...
![Struct passed by copy versus by pointer](assets/pointers-v3/06-struct-copy-vs-pointer.png)
...
![Value receiver versus pointer receiver diagram](assets/pointers-v3/07-pointer-receiver.png)
...
![Escape analysis flowchart: stack versus heap](assets/pointers-v3/08-stack-heap-escape.png)
...
![Slice header pointing to underlying array](assets/pointers-v3/09-slice-header.png)
...
![Pointer to pointer diagram](assets/pointers-v3/10-pointer-to-pointer.png)
...
![Loop variable trap — wrong: all pointers share one box](assets/pointers-v3/11-loop-trap-wrong.png)

![Loop variable trap — correct: each pointer gets its own box](assets/pointers-v3/12-loop-trap-correct.png)
