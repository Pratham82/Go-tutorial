...
![Pointer memory box diagram](assets/pointers/01-pointer-memory-box.png)
...
![Sequence diagram showing modification through a pointer](assets/pointers/02-modify-sequence.png)
...
![Nil pointer dereference flow diagram](assets/pointers/03-nil-pointer-flow.png)
...
![Function call without a pointer — copies the value](assets/pointers/04-func-without-pointer.png)

![Function call with a pointer — copies the address](assets/pointers/05-func-with-pointer.png)
...
![Struct passed by copy versus by pointer](assets/pointers/06-struct-copy-vs-pointer.png)
...
![Value receiver versus pointer receiver diagram](assets/pointers/07-pointer-receiver.png)
...
![Escape analysis flowchart: stack versus heap](assets/pointers/08-stack-heap-escape.png)
...
![Slice header pointing to underlying array](assets/pointers/09-slice-header.png)
...
![Pointer to pointer diagram](assets/pointers/10-pointer-to-pointer.png)
...
![Loop variable trap — wrong: all pointers share one box](assets/pointers/11-loop-trap-wrong.png)

![Loop variable trap — correct: each pointer gets its own box](assets/pointers/12-loop-trap-correct.png)
